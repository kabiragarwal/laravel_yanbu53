    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		<li><a href="{{ url('admin/dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
  		<li><a href="{{ url('admin/countries') }}"><i class="fa fa-th"></i> Country</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
				<div class="box box-info">
	              ...
	              {!! Form::model($country, array('url' => '/admin/country/update', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true)) !!}
				  	{!! Form::hidden('id', null) !!}
