    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		  <li><a href="{{ url('admin/dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
    		<li><a href="{{ url('admin/countries') }}"><i class="fa fa-th"></i> countries</a></li>
        ...
        <div class="col-xs-12">
            ...
            <!-- /.box-header -->
				<div class="box box-info">
	              ...
	              <!-- /.box-header -->
	              <!-- form start -->
	              {!! Form::model($country, array('url' => '/admin/user_update', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true)) !!}
	                ...
	                <div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
							  <p class="form-control-static">{{$country->slug}}</p>
							</div>
						</div>
