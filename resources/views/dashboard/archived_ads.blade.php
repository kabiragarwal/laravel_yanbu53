    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9 page-content">
                <div class="inner-box">
                    <h2 class="title-2"><i class="icon-folder-close"></i> Archived ads </h2>
                    <div class="table-responsive">
                        {{ Form::open(array('url'=>'/archived-ads', 'method'=>'post'))}}
                        ...
                        <table id="addManageTable" class="table table-striped table-bordered add-manage-table table demo" data-filter="#filter" data-filter-text-only="true">
                            ...
                            <tbody>
                                @if($archivedProduct->count())
                                    @foreach($archivedProduct as $product)
                                    <tr>
                                        ...
                                        <td style="width:10%" class="action-td"><div>
                                                ...
                                                <p> {{ Form::button('<i class="fa fa-mail-forward"></i> Repost', ['type'=>'submit', 'value'=>$product->id, 'name'=>'repost', 'class'=>'btn btn-info btn-xs']) }}
                                                    </p>
