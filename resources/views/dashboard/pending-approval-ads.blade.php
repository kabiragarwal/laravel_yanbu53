            ...
            <div class="col-sm-9 page-content">
                <div class="inner-box">
                    ...
                    <div class="table-responsive">
                        {{ Form::open(array('url'=>'/pending-approval-ads', 'method'=>'post'))}}
                                ...
                                @if($pendingProduct->count())
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:10%" class="action-td"><div>
                                                ...
                                                <p> {{ Form::button('<i class="fa fa-mail-forward"></i> Approve', ['type'=>'submit', 'value'=>$product->id, 'name'=>'confirm', 'class'=>'btn btn-info btn-xs']) }}</p>
